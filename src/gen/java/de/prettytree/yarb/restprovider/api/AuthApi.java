...
public interface AuthApi {
    ...
    @ApiOperation(value = "refreshToken", nickname = "refreshToken", notes = "Refresh a token and get userId", response = LoginData.class, authorizations = {
    ...
    ResponseEntity<LoginData> refreshToken();
